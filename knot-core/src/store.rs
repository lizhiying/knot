        ...
        let tantivy_query_text = {
            ...
            if let Some(mut jieba_tokenizer) = jieba {
                ...
                let stop_words: std::collections::HashSet<&str> = [
                    // 助词/语气词
                    "了", "的", "得", "地", "着", "过", "吗", "呢", "吧", "啊", "哦", "嗯", "呀",
                    "哪", // 代词
                    "你", "我", "他", "她", "它", "这", "那", "这个", "那个", "自己", "什么",
                    "怎么", "哪个", "哪些", // 介词/连词
                    "是", "在", "有", "和", "就", "不", "都", "也", "很", "到", "把", "被", "让",
                    "给", "从", "向", "为", "与", "及", "或", "但", "而", "且", "上", "下",
                    // 副词
                    "没有", "没", "还", "又", "再", "已", "已经", "将", "能", "会", "可以", "应该",
                    // 因果/条件
                    "如果", "因为", "所以", // 动词（指令性，不含语义信息）
                    "说", "看", "好", "去", "要", "人", "一", "一个", "一下", "列出", "告诉", "帮",
                    "帮我", "请", "请问", "查", "查询", "查看", "查找", "显示", "找", "找到",
                    "找出", "搜索", "给我", "出来",
                    // 量词（单独出现时无搜索意义）
                    "条", "个", "些", "项", "份", "张", "篇",
                    // 时间/程度副词（模糊指令，非精确搜索词）
                    "最", "最后", "最近", "最新", "最大", "最小", "第", "前", "后", "多少", "几",
                    "所有", "全部", "总共", "一共", "大概", "关于", "有关",
                ]
                .iter()
                .copied()
                .collect();
